...
(function () {
  ...
  var jsQueue = [p("js/common.js") + q, p("js/api.js") + q, p("js/supabase.js") + q, p("js/realtime.js") + q, p("js/notif.js") + q, p("js/auth-ui.js") + q, p("menu/menu.js") + q];
  function loadNext(i) {
    if (i >= jsQueue.length) {
